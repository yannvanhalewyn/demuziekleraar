        ...
        <div className="mt-16">
          <div className="flex items-center text-blue-300 font-semibold">
            <label
              ...
              className={`pricing-toggle__label ${!toggled ? "pricing-toggle__label--active" : ""}`}
            >
              Tot 21 jaar
            </label>
          ...
          <div className="mt-6 lg:flex lg:bg-blue-600 lg:rounded-xl lg:overflow-hidden lg:shadow-xl">
            {entry.getIn(["data", "pricingModels"]).map((pricingModel, i) => {
              return (
                <div
                  key={i}
                  className="lg:flex-1 p-6 xs:p-10 md:p-16 rounded-xl shadow-xl bg-blue-600 lg:rounded-none lg:shadow-none lg:bg-none {{ if (lt (add $idx 1) $modelsCount) }} mb-12 lg:mb-0 lg:border-r-2 lg:border-blue-300 {{ end }}"
                >
                  <div className="text-center">
                    <div
                      ...
                      style={{
                        backgroundImage: `url('${
                          pricingModel.get("name") === "Groepsles"
                            ? "/img/community.svg"
                            : "/img/professor.svg"
                        }')`,
                      }}
                    ...
                    <div className="mt-8">
                      <div>
                        ...
                        <span className="font-bold text-5xl">
                          {toggled ? pricingModel.get("priceAdults") : pricingModel.get("priceChildren")}
                        </span>
                      </div>
                      <span className="text-blue-300">
                        {pricingModel.get("priceSubtitle")}
                      </span>
                    </div>
                  ...
                  <div className="text-blue-300 sm:text-base">
                    {pricingModel.get("features").map((feature, i) => {
                      return (
                        <div key={i} className="flex items-center py-3">
                          ...
                          <p
                            ...
                            dangerouslySetInnerHTML={{
                              __html: markdownToHtml(feature.get("name")),
                            }}
                          ></p>
                        </div>
                      );
